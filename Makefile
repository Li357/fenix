...
C_SOURCES = drivers/gpio.c drivers/usart.c drivers/nvic.c drivers/ethernet.c drivers/systick.c drivers/rcc.c src/syscall.c src/main.c src/kernel.c src/list.c src/net.c
